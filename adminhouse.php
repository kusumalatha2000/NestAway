...
if($stmt = $con->query("select * from house where id=$id")){
...
if($stmt1 = $con->query("select * from house where id=$id")){
 ...
 echo "<table border=\"1\" class='table my_table'>
	...
	echo "</table>";
	echo "<br></br>";
	echo "<b> Popular Places : </b>";
	echo "<a href='adminpopular1.php?state=$state'>PopularPlaces in $state</a>";
	echo "<br></br>";
	echo "<b> Restaurants : </b>";
	echo "<a href='adminhotel1.php?state=$state'>Restaurants in $state</a>";
}
